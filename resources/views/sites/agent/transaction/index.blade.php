		...
		<div class="row">
			    ...
			    <div class="card">
                              ...
                              <div class="card-block">
                                  <form class="form-material" method="POST" action="{{route('agent_get_transaction_list')}}">
					@csrf
					  ...
					  <select id="req_type" name="request_type" class="form-control">
						  <option value="all">All(By you)</option>
