		...
		<div class="row">
			    ...
			    <div class="card">
                              ...
                              <div class="card-block">
                                  <form class="form-material" method="POST" action="{{route('payroll_create_review')}}">
					@csrf
					  ...
					  <select id="req_type" name="request_type" class="form-control">
						  ...
						  {{-- <option value="item">By Item</option> --}}
                                          ...
                                          <span class="form-bar"></span>
                                          <label class="float-label"><b>Type:</b></label>
                                          @error('request_type')
                                                <Span style="color: red;">{{$message}}</Span>
                                          @enderror
                                      </div><br>
				      ...
				      <div class="form-group form-default" id="data_list"></div>
                                      <div class="form-group form-default" style="">
                                          <input type="submit" class="btn btn-primary" id="load"  value="Click To Review" style="float: right; display: none;" id="">
                                      </div>
                                  </form>
                              </div>
                            </div>
