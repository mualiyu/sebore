        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">Payrolls By Agent</h5>
                </div>
            </div>
            <div class="col-md-4">
		    ...
		    ?>
		      <div class="card shadow" style="width:100%;">
			    ...
			    <div class="row">
                            ...
                            <div class="row">
                              <div class="col-sm-3">
                                <h6 class="mb-0" style="float: right;">Agent Name:</h6>
                              </div>
                              <div class="col-sm-9 text-secondary">
                                {{$agent->name}}
                              </div>
                            ...
                            <div class="row">
                              <div class="col-sm-3">
                                <h6 class="mb-0" style="float: right;">Agent Phone No:</h6>
                              </div>
                              <div class="col-sm-9 text-secondary">
                                {{$agent->phone}}
                              </div>
     			 ...
     			 <div class="row px-3 py-2">
                            <div class="col-sm-12">
                              <form action="{{route('payroll_store')}}" method="POST">
                                @csrf
                                <input type="hidden" name="tag" value="Agent({{$agent->id}})">
