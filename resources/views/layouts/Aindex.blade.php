            ...
            <div class="navbar-wrapper">
                <div class="navbar-logo">
                    ...
                    <a href="#">
                        ...
                        <a class="img-fluid">{{$organization->name}}</a>
                    </a>
                        ...
                        <li class="user-profile header-notification">
                            ...
                            <ul class="show-notification profile-notification">
                                <li class="waves-effect waves-light">
                                    <a href="{{route('agent_show_agent_profile')}}">
                ...
                <nav class="pcoded-navbar">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="">
                                <a href="{{route('agent_dashboard')}}" class="waves-effect waves-dark">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="">
                                <a href="{{route('agent_show_customers')}}" class="waves-effect waves-dark">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                             <li class="">
                                <a href="{{route('agent_show_transactions')}}" class="waves-effect waves-dark">
